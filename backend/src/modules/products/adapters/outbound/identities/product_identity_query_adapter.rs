...
use crate::modules::products::domain::value_objects::ProductActorId;
use crate::modules::products::ports::outbound::{ProductIdentityPort, ProductIdentityPortError};
...
impl ProductIdentityPort for ProductIdentityQueryAdapter {
    async fn check_verified(&self, actor_id: &ProductActorId) -> Result<bool, ProductIdentityPortError> {
        let identity_id = IdentityId::from_uuid(actor_id.as_uuid().to_owned());
