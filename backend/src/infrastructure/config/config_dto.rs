use crate::infrastructure::config::app_env::AppEnv;
use crate::infrastructure::config::auth::AuthConfigDto;
use crate::infrastructure::config::database::DatabaseConfigDto;
use crate::infrastructure::config::server::ServerConfigDto;
        ...
        let config = Config::builder()
            ...
            .add_source(
                Environment::with_prefix("APP")
                    .separator("__")
                    .try_parsing(true), // .list_separator(",")
